...
// Scene video/image URLs (using free stock sources)
const sceneAssets: Record<SceneType, { video?: string; image: string; fallback: string }> = {
    // CALM scenes
    mountains: {
        ...
        fallback: 'linear-gradient(135deg, #1a365d 0%, #2d3748 100%)',
    },
    beach: {
        ...
        fallback: 'linear-gradient(135deg, #0077b6 0%, #023e8a 100%)',
    },
    rain: {
        video: 'https://videos.pexels.com/video-files/6398107/6398107-hd_1920_1080_25fps.mp4',
        image: 'https://images.pexels.com/photos/1529360/pexels-photo-1529360.jpeg',
        fallback: 'linear-gradient(135deg, #4a5568 0%, #2d3748 100%)',
    },
    forest: {
        ...
        fallback: 'linear-gradient(135deg, #234e52 0%, #1a202c 100%)',
    },
    // FOCUS scenes
    library: {
        image: 'https://images.pexels.com/photos/590493/pexels-photo-590493.jpeg',
        fallback: 'linear-gradient(135deg, #44403c 0%, #292524 100%)',
    },
    cafe: {
        ...
        fallback: 'linear-gradient(135deg, #78350f 0%, #451a03 100%)',
    },
    minimal: {
        image: 'https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg',
        fallback: 'linear-gradient(135deg, #f5f5f4 0%, #e7e5e4 100%)',
    },
    nature: {
        ...
        fallback: 'linear-gradient(135deg, #065f46 0%, #064e3b 100%)',
    },
    // SLEEP scenes
    stars: {
        ...
        fallback: 'linear-gradient(135deg, #0f172a 0%, #020617 100%)',
    },
    campfire: {
        video: 'https://videos.pexels.com/video-files/857008/857008-hd_1920_1080_25fps.mp4',
        image: 'https://images.pexels.com/photos/1368382/pexels-photo-1368382.jpeg',
        fallback: 'linear-gradient(135deg, #7c2d12 0%, #1c1917 100%)',
    },
    snow: {
        ...
        fallback: 'linear-gradient(135deg, #e2e8f0 0%, #94a3b8 100%)',
    },
    clouds: {
        video: 'https://videos.pexels.com/video-files/2098989/2098989-hd_1920_1080_30fps.mp4',
        image: 'https://images.pexels.com/photos/158163/clouds-cloudporn-weather-lookup-158163.jpeg',
        fallback: 'linear-gradient(135deg, #60a5fa 0%, #3b82f6 100%)',
    },
    // ENERGY scenes
    sunrise: {
        video: 'https://videos.pexels.com/video-files/856462/856462-hd_1920_1080_30fps.mp4',
        image: 'https://images.pexels.com/photos/1179229/pexels-photo-1179229.jpeg',
        fallback: 'linear-gradient(135deg, #f97316 0%, #dc2626 100%)',
    },
    city: {
        ...
        fallback: 'linear-gradient(135deg, #6366f1 0%, #4f46e5 100%)',
    },
    ocean: {
        video: 'https://videos.pexels.com/video-files/1093662/1093662-hd_1920_1080_30fps.mp4',
        image: 'https://images.pexels.com/photos/1032650/pexels-photo-1032650.jpeg',
        fallback: 'linear-gradient(135deg, #0ea5e9 0%, #0284c7 100%)',
    },
    storm: {
    ...
    childhood: {
        ...
        fallback: 'linear-gradient(135deg, #fcd34d 0%, #f59e0b 100%)',
    },
    seasons: {
        video: 'https://videos.pexels.com/video-files/857251/857251-hd_1920_1080_30fps.mp4',
        image: 'https://images.pexels.com/photos/1179229/pexels-photo-1179229.jpeg',
        fallback: 'linear-gradient(135deg, #d97706 0%, #b45309 100%)',
    },
};

// Map mood to scene preference key
const moodToSceneKey: Record<Mood, 'calmScene' | 'focusScene' | 'sleepScene' | 'energyScene' | 'nostalgiaScene'> = {
    CALM: 'calmScene',
    FOCUS: 'focusScene',
    SLEEP: 'sleepScene',
    ENERGY: 'energyScene',
    NOSTALGIA: 'nostalgiaScene',
};
...
export function ScenePlayer() {
    ...
    // Get current scene based on mood and preferences
    const sceneKey = moodToSceneKey[currentMood];
    const currentScene = preferences[sceneKey] as SceneType;
    const assets = sceneAssets[currentScene] || sceneAssets.beach;
    ...
    return (
        <div className="absolute inset-0 z-0 overflow-hidden">
            ...
            {/* Image Fallback */}
            <div
                className={`absolute inset-0 w-full h-full bg-cover bg-center transition-opacity duration-1000 ${(!assets.video || videoError || !loaded) ? 'opacity-100' : 'opacity-0'
                    }`}
                style={{
